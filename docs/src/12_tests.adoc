...
==== Conclusiones
Los datos obtenidos durante las pruebas muestran un servicio estable, sin errores de servidor y con tiempos de respuesta aceptables. Pero hay que recordar que se está usando una muestra muy pequeña y una carga basstante nimia. Ya que esto no es una prueba de carga, si no una muestra de la monitorización de la aplicación.
