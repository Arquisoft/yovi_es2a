...
image::13-gatling_active_users.png[Evolución de usuarios activos, align="center"]
image::13-gatling_responses.png[Respuestas por segundo, align="center"]
...
image::13-gatling_distribution.png[Distribución de tiempos de respuesta, align="center"]
