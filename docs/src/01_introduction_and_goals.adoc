...
| Disfrutar de una buena experiencia de usuario, pudiendo jugar partidas de forma fluida, utilizar diferentes estrategias en el tablero hexagonal, consultar sus estadísticas y comparar su rendimiento con otros jugadores mediante el ranking globa
|===