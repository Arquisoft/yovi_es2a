...
Propósito: mantener una navegación segura permitiendo únicamente jugar y acceder a seccioens específicas a usuarios registrados en el sistema.
Responsabilidades:
...
==== Servicio de Emparejamiento (Matchmaking)
