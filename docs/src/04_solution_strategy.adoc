...
** _MongoDB:_ Base de datos no relacional elegida para garantizar la integridad de los datos de usuarios y mantener un registro fiable de los historiales de partidas.
